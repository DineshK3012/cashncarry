...
define('PAYTM_MERCHANT_KEY', 'VH5pekBTnKx@Qy3e'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'EIAHUv42989469805395'); //Change this constant's value with MID (Merchant ID) received from Paytm.
